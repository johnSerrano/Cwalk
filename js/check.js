...
//    "/19_return_values.php": { "answers": [ { "a": "98", "type": "input" } ] },
    ...
    "/40_pointer_here_we_are.php": { "answers": [ {"a": /\s*char\s*\*\s*/, "type": "regex"}  ] },
	"/41_point_to_something.php": { "answers": [ { "a": /\s*\*\s*p\s*/ , "type": "regex"} ] },
    "/42_print_this_pointer.php": { "answers": [ {"a": /\s*\*n\s*/, "type": "regex"} ] },
	"/43_would_it_fit_inside_a_breadbox.php": { "answers": [ { "a": "4" , "type": "input"}, { "a": "1" , "type": "input"}, { "a": "4" , "type": "input"}, { "a": "4" , "type": "input"} ] },
    "/44_nobody_at_this_address.php": { "answers": [{"a":  /\s*&c\s*;\s*/, "type": "regex"} ] },
    ...
    "/48_arrays_my_love.php": { "answers": [ {"a": /\s*a\[2\]\s*/, "type": "regex"} ] },
